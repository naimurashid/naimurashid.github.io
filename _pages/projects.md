...
<section class="page-section">
  <div class="focus-grid project-grid">
    ...
    <article class="project-card">
      ...
      <div class="project-card__links">
        <a href="/funding/#tbcrc-evolvebdt">Protocol summary</a>
      </div>
    </article>
...
Projects are co-developed with Gillings trainees, UNC Lineberger oncologists, and cooperative group collaborators. See [repositories](/repositories/) for code, or email [naim@unc.edu](mailto:naim@unc.edu) about pilot access. Gillings students can participate through BIOS 690 capstone projects and Lineberger internships.
